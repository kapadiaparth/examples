...
// Note that the aliases below will need to be replaced with your connection aliases (e.g. `{username}-postgres`)
...
// with your own alias in order to save this pipe to your account (e.g. `{username}-transfer-csv-to-elasticsearch`)
pipe.save({

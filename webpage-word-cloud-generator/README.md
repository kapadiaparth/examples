...
https://flexiodata.github.io/examples/webpage-word-cloud-generator/
...
**NOTE: The alias `flexio-webpage-word-cloud-generator-v1` below needs to be replaced with your own in order to save this pipe to your account. Best practices for aliases are to use your username as a prefix (e.g. `YOUR_USERNAME-webpage-word-cloud-generator-v1`).**
...
$.ajax({
  type: 'POST',
  url: 'https://www.flex.io/api/v1/pipes/YOUR_USERNAME-webpage-word-cloud-generator-v1/run?flexio_api_key=YOUR_API_KEY',
  data: {
...
```
curl -X POST 'https://www.flex.io/api/v1/pipes/YOUR_USERNAME-webpage-word-cloud-generator-v1/run' \

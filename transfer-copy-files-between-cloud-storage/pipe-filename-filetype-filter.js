...
// This is the Flex.io pipe logic to read all files named `myfile` regardless of extension, from an AWS S3
...
pipe.save({
  name: 'Copy Files Between Cloud Storage (filter on name and type)',
